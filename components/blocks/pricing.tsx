      ...
      <div className="grid grid-cols-1 md:grid-cols-3 sm:2 gap-4">
        {plans.map((plan, index) => (
          <motion.div
            ...
            className={cn(
              `rounded-2xl border-[1px] p-6 bg-black/50 backdrop-blur-sm text-center lg:flex lg:flex-col lg:justify-center relative`,
              plan.isPopular ? "border-white border-2" : "border-white/20",
              "flex flex-col",
              !plan.isPopular && "mt-5",
              index === 0 || index === 2
